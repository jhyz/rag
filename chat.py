...
def get_model_response(multi_modal_input,history,model,temperature,max_tokens,history_round,db_name,similarity_threshold,chunk_cnt):
    ...
    try:
        ...
        prompt_template = f"您是一位对长江经济带产业创新有着深刻认知的专家。您的任务是：1.分析并参考检索到的长江经济带产业创新的相关信息，这些信息可能与当前长江经济带产业创新发展相关。2.确保您的分析和建议基于最新的长江经济带产业发展现状。3.聊天回答要具有针对性，围绕所提出的问题展开，不要太宽泛。，请参考以下内容：{chunk_text}，以合适的语气回答用户的问题：{prompt}，请确保您的分析全面、建议切实可行，并充分利用提供的参考信息。"
